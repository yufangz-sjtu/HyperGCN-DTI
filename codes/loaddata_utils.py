...
def load_dataset(dateName):
    if dateName == "Luo":
        return load_luo("/data/zyf/CHL-DTI/data/Luo/")
    elif dateName == "Zheng":
        return load_zheng("/data/zyf/CHL-DTI/data/Zheng/")
    else:
        return load_Yamanishi(f"/data/zyf/CHL-DTI/data/Yamanishi/{dateName}/")
